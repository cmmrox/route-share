...
export const adaptRideSearchResult = (input: unknown): RideSearchResult => {
  ...
  return {
    ...
    routeOccurrenceId: routeOccurrenceId || undefined,
    ...
    matchScore: numberFrom(source.score, source.matchScore),
    ...
    matchedDistanceMeters: numberFrom(source.matchedDistanceMeters),
    pickupRouteFraction: numberFrom(source.pickupRouteFraction),
    dropoffRouteFraction: numberFrom(source.dropoffRouteFraction),
    explanation: typeof source.explanation === "string" ? source.explanation : undefined,
    fareEstimateLkr: numberFrom(source.estimatedFare, source.fareEstimateLkr, source.fareEstimate),
    ...
    driverName: typeof source.driverName === "string" ? source.driverName : undefined,
    vehicleMake: typeof source.vehicleMake === "string" ? source.vehicleMake : undefined,
    vehicleModel: typeof source.vehicleModel === "string" ? source.vehicleModel : undefined,
    vehicleRegistration: typeof source.vehicleRegistration === "string" ? source.vehicleRegistration : undefined,
    vehicleSeatCount: numberFrom(source.vehicleSeatCount),
    raw: input
  };
};
