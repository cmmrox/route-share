...
public class DriverSupportController {
  ...
  public DriverSupportController(SupportService service) {
    this.service = service;
  }

  @PostMapping
  ApiResponse<SupportTicketResponse> create(@Valid @RequestBody CreateTicketRequest req) {
    return ApiResponse.ok(service.create("DRIVER", req));
  }
  ...
  ApiResponse<SupportMessageResponse> addMessage(
    ...
    return ApiResponse.ok(service.addMessage("DRIVER", ticketId, req));
  }
}
