    ...
    ios: {
      ...
      infoPlist: {
        NSLocationWhenInUseUsageDescription:
          'RouteShare uses your location to find nearby shared rides, pickup points, and safe trip progress.',
        NSLocationAlwaysAndWhenInUseUsageDescription:
          'RouteShare uses background location only during active trips for passenger safety and trip progress.',
        NSCameraUsageDescription: 'RouteShare may use the camera for profile and support attachments.',
        NSPhotoLibraryUsageDescription: 'RouteShare may access selected photos for profile and support attachments.',
        NSPhotoLibraryAddUsageDescription:
          'RouteShare may save edited profile photos when you choose to update your passenger profile.',
      },
    },
    android: {
