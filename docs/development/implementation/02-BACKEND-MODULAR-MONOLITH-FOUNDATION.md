...
**Files:**
- Create/update: `apps/api/pom.xml`
- Create/update: `apps/api/src/main/java/com/routeshare/RouteShareApplication.java`
- Create/update: `apps/api/src/main/resources/application.yml`
