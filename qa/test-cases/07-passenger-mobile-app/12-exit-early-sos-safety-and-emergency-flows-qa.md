...
- Required YAML: `qa/maestro/passenger-mobile/regression/task12-exit-early-sos-safety-emergency.yaml`.
- Run with `scripts/qa-passenger-android.sh qa/maestro/passenger-mobile/regression/task12-exit-early-sos-safety-emergency.yaml` on emulator/device.
