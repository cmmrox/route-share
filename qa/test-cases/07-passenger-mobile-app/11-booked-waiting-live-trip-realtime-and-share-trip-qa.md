...
- Required YAML: `qa/maestro/passenger-mobile/regression/task11-booked-waiting-live-trip-share-trip.yaml`.
- Run with `scripts/qa-passenger-android.sh qa/maestro/passenger-mobile/regression/task11-booked-waiting-live-trip-share-trip.yaml` on emulator/device.
