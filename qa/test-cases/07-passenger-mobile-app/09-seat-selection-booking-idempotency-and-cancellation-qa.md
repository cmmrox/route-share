...
- Required YAML: `qa/maestro/passenger-mobile/regression/task09-seat-selection-booking-idempotency-cancellation.yaml`.
- Run with `scripts/qa-passenger-android.sh qa/maestro/passenger-mobile/regression/task09-seat-selection-booking-idempotency-cancellation.yaml` on emulator/device.
